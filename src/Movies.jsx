...
export default function Movies() {
  ...
  async function GetTrending(pageNumber){
    let {data} = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=2d5c3f1e24667af22ea6c950439322a0&include_adult=false&include_video=false&language=en-US%25sort_by%3Dpopularity.desc&page=${pageNumber}`)
  ...
  return (
<>
{TrendingMovies?<div className="row pt-5 justify-content-center">
